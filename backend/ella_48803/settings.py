"""
Django settings for ella_48803 project.
...
WSGI_APPLICATION = 'ella_48803.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Ella Support <support@ella-48803.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ella_48803 API",
    "DESCRIPTION": "API documentation for ella_48803 App",
    "VERSION": "v1",
}
